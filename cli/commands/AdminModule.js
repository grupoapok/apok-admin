...
const createEntryComponent = (entryPageFile, name) => {
  fs.copyFileSync('node_modules/@josercl/vue-admin/cli/templates/PageEntry.vue', entryPageFile);
...
const createListComponent = (listPageFile, moduleName, vuexModule, crudObject) => {
  fs.copyFileSync('node_modules/@josercl/vue-admin/cli/templates/PageList.vue', listPageFile);
...
const createEditComponent = (editPageFile, moduleName, vuexModule, crudObject, crudObjectVar) => {
  fs.copyFileSync('node_modules/@josercl/vue-admin/cli/templates/PageEdit.vue', editPageFile);
...
const createRoutesFile = (routesFile, moduleName) => {
  fs.copyFileSync('node_modules/@josercl/vue-admin/cli/templates/PageRoutes.js', routesFile);
